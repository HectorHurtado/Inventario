...
public class Movement {
    ...
    public Movement(Long id, Long idProduct, Integer amount, Float salePrice, Date saleDate) {
        ...
        validarObligatorio(saleDate, SE_DEBE_INGRESAR_LA_FECHA_DEL_MOVIMIENTO);
